...
export const users = [
  {
    ...
    favorites: ['1', '2'], friends: ['user_2'], inventory: [], library: ['1'], achievements: ['ach_1', 'ach_2']
  },
  {
    ...
    history: [], favorites: [], friends: ['user_1'], inventory: [], library: [], achievements: ['ach_1']
  }
];

export const directMessages: Record<string, any[]> = {
  // Format: "user1_user2" (alphabetically sorted IDs to ensure consistent key)
  'user_1_user_2': [
